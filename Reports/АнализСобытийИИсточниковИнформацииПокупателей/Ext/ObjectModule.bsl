...
СтрокаПоказателя.ПредставлениеПоказателя  = "Сумма выручки в (" + мВалютаУпрУчета + ")";
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "ВыручкаБезНДС";
СтрокаПоказателя.ПредставлениеПоказателя  = "Сумма выручки без НДС в (" + мВалютаУпрУчета + ")";
СтрокаПоказателя = ПоказателиОтчета.Добавить();
СтрокаПоказателя.ИмяПоказателя = "Прибыль";
СтрокаПоказателя.ПредставлениеПоказателя = "Сумма прибыли в (" + мВалютаУпрУчета + ")";
СтрокаПоказателя = ПоказателиОтчета.Добавить();
