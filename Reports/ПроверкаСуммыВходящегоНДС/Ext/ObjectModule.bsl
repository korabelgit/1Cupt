...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "ПервоеСобытие",				"Сумма требующая подтверждения налоговыми документами");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("ПервоеСобытие", "Сумма требующая подтверждения налоговыми документами", Истина, "ЧЦ=15; ЧДЦ=3");
