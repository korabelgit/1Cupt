...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолНачОст",          "Количество нач. остаток (в ед. хранения)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолПриход",          "Количество приход (в ед. хранения)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолРасход",          "Количество расход (в ед. хранения)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолКонОст",          "Количество кон. остаток (в ед. хранения)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель( "КолНачОст",          "Начальный остаток",   Ложь, "ЧЦ=15; ЧДЦ=3", "КолХран", "Количество (в ед. хранения)");
	УниверсальныйОтчет.ДобавитьПоказатель( "КолПриход",          "Приход",              Ложь, "ЧЦ=15; ЧДЦ=3", "КолХран", "Количество (в ед. хранения)");
	УниверсальныйОтчет.ДобавитьПоказатель( "КолРасход",          "Расход",              Ложь, "ЧЦ=15; ЧДЦ=3", "КолХран", "Количество (в ед. хранения)");
	УниверсальныйОтчет.ДобавитьПоказатель( "КолКонОст",          "Конечный остаток",    Ложь, "ЧЦ=15; ЧДЦ=3", "КолХран", "Количество (в ед. хранения)");
	
	УниверсальныйОтчет.ДобавитьПоказатель( "КолНачОстБазовЕд",   "Начальный остаток",   Ложь, "ЧЦ=15; ЧДЦ=3", "КолБазЕд", "Количество (в базовых ед.)");
	УниверсальныйОтчет.ДобавитьПоказатель( "КолПриходБазовЕд",   "Приход",              Ложь, "ЧЦ=15; ЧДЦ=3", "КолБазЕд", "Количество (в базовых ед.)");
	УниверсальныйОтчет.ДобавитьПоказатель( "КолРасходБазовЕд",   "Расход",              Ложь, "ЧЦ=15; ЧДЦ=3", "КолБазЕд", "Количество (в базовых ед.)");
	УниверсальныйОтчет.ДобавитьПоказатель( "КолКонОстБазовЕд",   "Конечный остаток",    Ложь, "ЧЦ=15; ЧДЦ=3", "КолБазЕд", "Количество (в базовых ед.)");
	
	УниверсальныйОтчет.ДобавитьПоказатель( "КолНачОстЕдОтчетов", "Начальный остаток", Истина, "ЧЦ=15; ЧДЦ=3", "КолЕдОтчетов", "Количество (в ед. отчетов)");
	УниверсальныйОтчет.ДобавитьПоказатель( "КолПриходЕдОтчетов", "Приход",            Истина, "ЧЦ=15; ЧДЦ=3", "КолЕдОтчетов", "Количество (в ед. отчетов)");
	УниверсальныйОтчет.ДобавитьПоказатель( "КолРасходЕдОтчетов", "Расход",            Истина, "ЧЦ=15; ЧДЦ=3", "КолЕдОтчетов", "Количество (в ед. отчетов)");
	УниверсальныйОтчет.ДобавитьПоказатель( "КолКонОстЕдОтчетов", "Конечный остаток",  Истина, "ЧЦ=15; ЧДЦ=3", "КолЕдОтчетов", "Количество (в ед. отчетов)");
