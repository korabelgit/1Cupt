...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок = Ложь, ВысотаЗаголовка = 0, ТолькоЗаголовок = Ложь) Экспорт
	...
	Область.Параметры.ДатаРасходовС  = Формат(ДатаРасходовС,"Л="+Локализация.ОпределитьКодЯзыкаДляФормат(КодЯзыкаПечать)+"; ДЛФ=DD");
	Область.Параметры.ДатаРасходовПо = Формат(ДатаРасходовПо,"Л="+Локализация.ОпределитьКодЯзыкаДляФормат(КодЯзыкаПечать)+"; ДЛФ=DD");
	Область.Параметры.ДатаПриходовС  = Формат(ДатаПриходовС,"Л="+Локализация.ОпределитьКодЯзыкаДляФормат(КодЯзыкаПечать)+"; ДЛФ=DD");
	Область.Параметры.ДатаПриходовПо = Формат(ДатаПриходовПо,"Л="+Локализация.ОпределитьКодЯзыкаДляФормат(КодЯзыкаПечать)+"; ДЛФ=DD");
