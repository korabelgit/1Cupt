...
НоваяФорма.ОписаниеОтчета     =  НСтр("ru = 'Приложение к Положению (стандарту) бухучета №25 (с изменениями, внесенными приказами Минфином Украины № 627 от 27.06.13)'; uk = 'Додаток до Положення (стандарту) бухобліку №25 (зі змінами, внесеними наказами Мінфіном України №627 від 27.06.13)'");
