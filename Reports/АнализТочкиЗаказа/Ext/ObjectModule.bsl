...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	|			ТОГДА ВЫБОР
	|					КОГДА ВложенныйЗапрос.ЗначениеТочкиЗаказа > ВложенныйЗапрос.МинимальныйСтраховойЗапас
	|						ТОГДА ВложенныйЗапрос.ЗначениеТочкиЗаказа - ВложенныйЗапрос.Остаток
	|					ИНАЧЕ ВложенныйЗапрос.МинимальныйСтраховойЗапас - ВложенныйЗапрос.Остаток
	|				КОНЕЦ
	|		ИНАЧЕ 0
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ЗначениеТочкиЗаказаЕдиницОтчетов", "Значение точки заказа (в ед. отчетов)");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("МинимальныйСтраховойЗапасЕдиницОтчетов", "Минимальный страховой запас (в ед. отчетов)");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОстатокЕдиницОтчетов", "Остаток (в ед. отчетов)");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ПросроченноеПоступлениеЕдиницОтчетов", "Просроченное поступление (в ед. отчетов)");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("ОжидаемоеПоступлениеЕдиницОтчетов", "Ожидаемое поступление (в ед. отчетов)");
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("РекомендуемыйОбъемЗакупкиЕдиницОтчетов", "Рекомендуемый объем закупки (в ед. отчетов)");
