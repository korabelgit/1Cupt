...
НоваяФорма.ОписаниеОтчета     = НСтр("ru = 'Утверждена Приказом Минфина Украины от 23.09.2014 № 966'; uk = 'Затверджено Наказом Міністерства фінінсів від 23.09.2014 № 966'");
НоваяФорма.ДатаНачалоДействия = '2014-12-01';
НоваяФорма.ДатаКонецДействия  = '2015-01-31';
	
НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2015";
НоваяФорма.ОписаниеОтчета     = НСтр("ru = 'Утверждена Приказом Минфина Украины от 23.09.2014 № 966 (в редакции Приказа от 23.01.2015 г. N 13)'; uk = 'Затверджено Наказом Міністерства фінінсів від 23.09.2014 № 966 (у редакції Наказу від 23.01.2015 р. N 13'");
