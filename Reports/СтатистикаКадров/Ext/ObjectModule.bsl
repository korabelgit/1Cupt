...
Процедура ВывестиСтроку(Выборка, СтруктураПараметров, ТипЗаписиВыборки, ИмяГруппировки)
	...
	ИначеЕсли ТипЗаписиВыборки = ТипЗаписиЗапроса.ОбщийИтог Тогда
		ЗначениеГруппировки = НСтр("ru='ИТОГО: ';uk='ВСЬОГО: '",мКодЯзыкаПечать);
	КонецЕсли;
...
Функция СтатистикаСпискиПолучитьОписаниеВсехПолей(ОсновнойИсточник, СписокРегистровСведений, ТаблицаПараметрыЗапроса) Экспорт
	...
	Для Каждого ЭлементСписка Из СписокРегистровСведений Цикл
		...
		Если ЭлементСписка.Значение = "РаботникиОрганизаций" Тогда
			...
			НовоеОписаниеПоля.ПредставлениеПоля =  НСтр("ru='Кол-во работающих по основному месту';uk='Кількість працюючих за основним місцем'",мКодЯзыкаПечать);
			...
			НовоеОписаниеПоля.ПредставлениеПоля = НСтр("ru='Кол-во работающих по внешнему совместительству';uk='Кількість працюючих за зовнішнім сумісництвом'",мКодЯзыкаПечать);
			...
			НовоеОписаниеПоля.ПредставлениеПоля = НСтр("ru='Кол-во работающих по внутреннему совместительству';uk='Кількість працюючих за внутрішнім сумісництвом'",мКодЯзыкаПечать);;
	...
	НоваяСтрока = ТаблицаОписаниеВсехПолей.Добавить();
	НоваяСтрока.ИмяИсточника = ИмяРегистра;
	НоваяСтрока.ПредставлениеПоля = НСтр("ru='Фамилия И.О.';uk='ПІБ'",мКодЯзыкаПечать);
	...
	Пока Выборка.Следующий() цикл
		...
		ИначеЕсли Выборка.ИмяСправочника = "СтепениРодстваФизЛиц" тогда				
			...
			НовоеОписаниеПоля.ПредставлениеПоля = НСтр("ru='Кол-во родственников по степени: ';uk='Кількість родичів за ступенем: '",мКодЯзыкаПечать)+Выборка.Представление;
	...
	НовоеОписаниеПоля.ПредставлениеПоля = НСтр("ru='Кол-во записей об образовании';uk='Кількість записів про освіту'",мКодЯзыкаПечать);
	НовоеОписаниеПоля.ОписаниеПоля      = "1";
	НовоеОписаниеПоля.ИтоговоеПоле	    = ИСТИНА;
	НовоеОписаниеПоля.ТипПоля   		= "Вычисляемое";
	НовоеОписаниеПоля.ОписаниеТипов     = ОписаниеТиповЧисло;
	...
	НовоеОписаниеПоля.ПредставлениеПоля = НСтр("ru='Кол-во записей об иностранных языках';uk='Кількість записів про іноземні мови'",мКодЯзыкаПечать);
	НовоеОписаниеПоля.ОписаниеПоля      = "1";
	НовоеОписаниеПоля.ИтоговоеПоле	    = ИСТИНА;
	НовоеОписаниеПоля.ТипПоля   		= "Вычисляемое";
	НовоеОписаниеПоля.ОписаниеТипов     = ОписаниеТиповЧисло;
	...
	НовоеОписаниеПоля.ПредставлениеПоля = НСтр("ru='Кол-во записей в трудовой книжке';uk='Кількість записів в трудовій книжці'",мКодЯзыкаПечать);
	НовоеОписаниеПоля.ОписаниеПоля      = "1";
	НовоеОписаниеПоля.ИтоговоеПоле	    = ИСТИНА;
	НовоеОписаниеПоля.ТипПоля   		= "Вычисляемое";
	НовоеОписаниеПоля.ОписаниеТипов     = ОписаниеТиповЧисло;
