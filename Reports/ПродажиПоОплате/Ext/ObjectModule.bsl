...
// в течение периода отчета.
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить("КоличествоЕдиницДляОтчетовОборот", "Количество (в ед. отчетов)");
	...
	УниверсальныйОтчет.ДобавитьПоказатель("КоличествоЕдиницДляОтчетовОборот", "Количество (в ед. отчетов)", Ложь, "ЧЦ=15; ЧДЦ=3");
