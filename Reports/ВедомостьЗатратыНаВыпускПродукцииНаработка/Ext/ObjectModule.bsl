...
Процедура УстановитьНачальныеНастройкиУпр(ДополнительныеПараметры = Неопределено)
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КоличествоНачальныйОстаток", "Количество нач. остаток (в ед. хранения)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КоличествоПриход",           "Количество приход (в ед. хранения)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КоличествоРасход",           "Количество расход (в ед. хранения)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КоличествоКонечныйОстаток",  "Количество кон. остаток (в ед. хранения)");
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолНачОстБазовЕд",   "Количество нач. остаток (в базовых ед.)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолПриходБазовЕд",   "Количество приход (в базовых ед.)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолРасходБазовЕд",   "Количество расход (в базовых ед.)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолКонОстБазовЕд",   "Количество кон. остаток (в базовых ед.)");
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолНачОстЕдОтчетов", "Количество нач. остаток (в ед. отчетов)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолПриходЕдОтчетов", "Количество приход (в ед. отчетов)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолРасходЕдОтчетов", "Количество расход (в ед. отчетов)");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "КолКонОстЕдОтчетов", "Количество кон. остаток (в ед. отчетов)");
...
Процедура УстановитьНачальныеНастройкиБух(ДополнительныеПараметры = Неопределено)
	...
	ТекстЗапроса = "
		...
		|	РегЗатратыНаВыпуск.НалоговоеНазначение КАК НалоговоеНазначение,
		|	ПРЕДСТАВЛЕНИЕ(РегЗатратыНаВыпуск.НалоговоеНазначение),
		|	РегЗатратыНаВыпуск.Продукция КАК Продукция,
		|	ПРЕДСТАВЛЕНИЕ(РегЗатратыНаВыпуск.Продукция),
		|	РегЗатратыНаВыпуск.ХарактеристикаПродукции КАК ХарактеристикаПродукции,
		|	ПРЕДСТАВЛЕНИЕ(РегЗатратыНаВыпуск.ХарактеристикаПродукции),
		...
		|	РегЗатратыНаВыпуск.СуммаРасход КАК СуммаРасход,
		|	РегЗатратыНаВыпуск.СуммаКонечныйОстаток КАК СуммаКонечныйОстаток,
		|	РегЗатратыНаВыпуск.СуммаНУНачальныйОстаток КАК СуммаНУНачальныйОстаток,
		|	РегЗатратыНаВыпуск.СуммаНУПриход КАК СуммаНУПриход,
		|	РегЗатратыНаВыпуск.СуммаНУРасход КАК СуммаНУРасход,
		|	РегЗатратыНаВыпуск.СуммаНУКонечныйОстаток КАК СуммаНУКонечныйОстаток,
		|	РегЗатратыНаВыпуск.НДСВходящийНачальныйОстаток КАК НДСВходящийНачальныйОстаток,
		|	РегЗатратыНаВыпуск.НДСВходящийПриход КАК НДСВходящийПриход,
		|	РегЗатратыНаВыпуск.НДСВходящийРасход КАК НДСВходящийРасход,
		|	РегЗатратыНаВыпуск.НДСВходящийКонечныйОстаток КАК НДСВходящийКонечныйОстаток,
		|	РегЗатратыНаВыпуск.НДСКредитНачальныйОстаток КАК НДСКредитНачальныйОстаток,
		|	РегЗатратыНаВыпуск.НДСКредитПриход КАК НДСКредитПриход,
		|	РегЗатратыНаВыпуск.НДСКредитРасход КАК НДСКредитРасход,
		|	РегЗатратыНаВыпуск.НДСКредитКонечныйОстаток КАК НДСКредитКонечныйОстаток,
		|	РегЗатратыНаВыпуск.Регистратор КАК Регистратор,
		|	ПРЕДСТАВЛЕНИЕ(РегЗатратыНаВыпуск.Регистратор),
		|	РегЗатратыНаВыпуск.Период КАК Период,
		|	НАЧАЛОПЕРИОДА(РегЗатратыНаВыпуск.Период, ДЕНЬ) КАК ПериодДень,
		...
		|	СуммаРасход,
		|	СуммаКонечныйОстаток,
		|	СуммаНУНачальныйОстаток,
		|	СуммаНУПриход,
		|	СуммаНУРасход,
		|	СуммаНУКонечныйОстаток,
		...
		|	РегЗатратыНаВыпуск.СуммаРасход,
		|	РегЗатратыНаВыпуск.СуммаКонечныйОстаток,
		|	РегЗатратыНаВыпуск.СуммаНУНачальныйОстаток,
		|	РегЗатратыНаВыпуск.СуммаНУПриход,
		|	РегЗатратыНаВыпуск.СуммаНУРасход,
		|	РегЗатратыНаВыпуск.СуммаНУКонечныйОстаток,
		|	РегЗатратыНаВыпуск.НДСВходящийНачальныйОстаток,
		|	РегЗатратыНаВыпуск.НДСВходящийПриход,
		|	РегЗатратыНаВыпуск.НДСВходящийРасход,
		|	РегЗатратыНаВыпуск.НДСВходящийКонечныйОстаток,
		|	РегЗатратыНаВыпуск.НДСКредитНачальныйОстаток,
		|	РегЗатратыНаВыпуск.НДСКредитПриход,
		|	РегЗатратыНаВыпуск.НДСКредитРасход,
		|	РегЗатратыНаВыпуск.НДСКредитКонечныйОстаток,
		|	РегЗатратыНаВыпуск.Период,
		|	НАЧАЛОПЕРИОДА(РегЗатратыНаВыпуск.Период, ДЕНЬ) КАК ПериодДень,
		|	НАЧАЛОПЕРИОДА(РегЗатратыНаВыпуск.Период, НЕДЕЛЯ) КАК ПериодНеделя,
		|	НАЧАЛОПЕРИОДА(РегЗатратыНаВыпуск.Период, ДЕКАДА) КАК ПериодДекада,
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "СуммаНУНачальныйОстаток",      "Сумма (НУ) нач. остаток");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "СуммаНУПриход",                "Сумма (НУ) приход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "СуммаНУРасход",                "Сумма (НУ) расход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "СуммаНУКонечныйОстаток",       "Сумма (НУ) кон. остаток");
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "НДСВходящийНачальныйОстаток",      "НДС вход. нач. остаток");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "НДСВходящийПриход",                "НДС вход. приход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "НДСВходящийРасход",                "НДС вход. расход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "НДСВходящийКонечныйОстаток",       "НДС вход. кон. остаток");
	
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "НДСКредитНачальныйОстаток",      "НДС кредит нач. остаток");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "НДСКредитПриход",                "НДС кредит приход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "НДСКредитРасход",                "НДС кредит расход");
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "НДСКредитКонечныйОстаток",       "НДС кредит кон. остаток");
	...
	УниверсальныйОтчет.ДобавитьПоказатель( "СуммаНУНачальныйОстаток",      "Начальный остаток", Истина, "ЧЦ=15; ЧДЦ=2", "СуммаНУ", "Сумма (НУ)");
	УниверсальныйОтчет.ДобавитьПоказатель( "СуммаНУПриход",                "Приход",            Истина, "ЧЦ=15; ЧДЦ=2", "СуммаНУ", "Сумма (НУ)");
	УниверсальныйОтчет.ДобавитьПоказатель( "СуммаНУРасход",                "Расход",            Истина, "ЧЦ=15; ЧДЦ=2", "СуммаНУ", "Сумма (НУ)");
	УниверсальныйОтчет.ДобавитьПоказатель( "СуммаНУКонечныйОстаток",       "Конечный остаток",  Истина, "ЧЦ=15; ЧДЦ=2", "СуммаНУ", "Сумма (НУ)");
	
	УниверсальныйОтчет.ДобавитьПоказатель( "НДСВходящийНачальныйОстаток",      "Начальный остаток", Истина, "ЧЦ=15; ЧДЦ=2", "НДСВходящий", "НДС входящий");
	УниверсальныйОтчет.ДобавитьПоказатель( "НДСВходящийПриход",                "Приход",            Истина, "ЧЦ=15; ЧДЦ=2", "НДСВходящий", "НДС входящий");
	УниверсальныйОтчет.ДобавитьПоказатель( "НДСВходящийРасход",                "Расход",            Истина, "ЧЦ=15; ЧДЦ=2", "НДСВходящий", "НДС входящий");
	УниверсальныйОтчет.ДобавитьПоказатель( "НДСВходящийКонечныйОстаток",       "Конечный остаток",  Истина, "ЧЦ=15; ЧДЦ=2", "НДСВходящий", "НДС входящий");
	
	УниверсальныйОтчет.ДобавитьПоказатель( "НДСКредитНачальныйОстаток",      "Начальный остаток", Истина, "ЧЦ=15; ЧДЦ=2", "НДСКредит", "НДС кредит");
	УниверсальныйОтчет.ДобавитьПоказатель( "НДСКредитПриход",                "Приход",            Истина, "ЧЦ=15; ЧДЦ=2", "НДСКредит", "НДС кредит");
	УниверсальныйОтчет.ДобавитьПоказатель( "НДСКредитРасход",                "Расход",            Истина, "ЧЦ=15; ЧДЦ=2", "НДСКредит", "НДС кредит");
	УниверсальныйОтчет.ДобавитьПоказатель( "НДСКредитКонечныйОстаток",       "Конечный остаток",  Истина, "ЧЦ=15; ЧДЦ=2", "НДСКредит", "НДС кредит");
