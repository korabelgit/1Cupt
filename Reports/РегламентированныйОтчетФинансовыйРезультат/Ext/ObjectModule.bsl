...
НоваяФорма.ОписаниеОтчета     =  НСтр("ru = 'Приложение к П(с)БУ №1 ""Общие требования к финансовой отчетности"" с изменениями внесенными Приказом Минфина Украины от 08.02.2014 № 48'; uk = 'Додаток до П(с)БО  №1 ""Загальні вимоги до фінансової звітності""  зі змінами внесеними Наказом Мінфина України від 08.02.2014 № 48'");
