...
НоваяФорма.ОписаниеОтчета     = "Затверджена наказом Міністерства доходів і сборів України від 11.11.2013 N 669";
НоваяФорма.ДатаНачалоДействия = '2013-01-01';
НоваяФорма.ДатаКонецДействия  = '2014-12-31';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2016";
НоваяФорма.ОписаниеОтчета     = "Затверджена наказом Міністерства доходів і сборів України від 18.01.2016  № 8";
