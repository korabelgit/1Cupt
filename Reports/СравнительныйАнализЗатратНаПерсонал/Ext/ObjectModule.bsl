...
Функция СформироватьОтчет(Результат = Неопределено, ДанныеРасшифровки = Неопределено, ВыводВФормуОтчета = Истина) Экспорт
	...
	Для каждого СтрокаТаблицыСценария из Сценарии Цикл
		...
		Если СтрокаТаблицыСценария.Сценарий.Пустая() Тогда
			СтрокаТаблицыСценария.НазваниеКолонки = ?(Номер = 1,НСтр( "ru='Эталонный период.';uk='Еталонний період.';" ,КодЯзыка),НСтр( "ru='Сравниваемый период ';uk='Порівнюваний період ';" ,КодЯзыка) + Номер + ".")
