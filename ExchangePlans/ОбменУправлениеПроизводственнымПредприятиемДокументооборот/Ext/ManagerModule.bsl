...
Функция ЗаголовокКомандыДляСозданияНовогоОбменаДанными() Экспорт
	...
	Возврат НСтр("ru = 'Создать обмен с конфигурацией ""Документооборот КОРП для Украины, ред. 2.0""'");
...
Функция КраткаяИнформацияПоОбмену() Экспорт
	...
	ПоясняющийТекст = НСтр("ru = 'Позволяет синхронизировать данные между конфигурациями ""Управление производственным предприятием для Украины"", ред. 1.3, и ""Документооборот КОРП для Украины"", ред. 2.0.
