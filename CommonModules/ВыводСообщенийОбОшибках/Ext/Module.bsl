...
Функция ДобавитьПростоеОписаниеОшибки(Ошибки, Описание = "", Ссылка = Неопределено) Экспорт
	...
	ТаблицаЛокализацияДетально = Ошибка.Данные.ЛокализацияДетально;
	ТаблицаЛокализацияДетально.Колонки.Добавить("Локализация", Новый ОписаниеТипов("Строка")); // "Ошибка в следующем месте"
	ТаблицаЛокализацияДетально.Колонки.Добавить("Ссылка");                                     // <переход по ссылке - первый шаг к исправлению>
