...
Процедура ОбработатьИзмененияПоКнопкеЦеныВалюта(ДокументОбъект, СпособЗаполненияЦен,
	...
	ЕстьСуммаАкцизногоНалога 	   = ОбщегоНазначения.ЕстьРеквизитТабЧастиДокумента("СуммаАкцизногоНалога", МетаданныеДокумента, ИмяТабличнойЧасти);
	...
	Если СтруктураЗначений.ПерезаполнитьЦеныПоТипу и ЕстьЦена Тогда
		...
		Для каждого СтрокаТабличнойЧасти Из ДокументОбъект[ИмяТабличнойЧасти] Цикл
			...
			Если ЕстьСуммаАкцизногоНалога И ЕстьСумма Тогда
				ОбработкаТабличныхЧастей.РассчитатьСуммуНДСиАкцизногоНалогаТабЧасти(СтрокаТабличнойЧасти, ДокументОбъект);
			ИначеЕсли ЕстьСуммаНДС И ЕстьСумма Тогда 	
	...
	ИначеЕсли (ИмяТабличнойЧасти = "ОбъектыСтроительства" или ИмяТабличнойЧасти = "НематериальныеАктивы" или ИмяТабличнойЧасти = "ОС") И ЕстьСумма И ЕстьСуммаНДС И НЕ ЕстьЦена Тогда // таб. часть ОбъектыСтроительства
				...
				Иначе
					Если ЕстьЦена Тогда
						...
						Если ЕстьСумма Тогда
							...
							Если ЕстьСуммаАкцизногоНалога Тогда
								ОбработкаТабличныхЧастей.РассчитатьСуммуНДСиАкцизногоНалогаТабЧасти(СтрокаТабличнойЧасти, ДокументОбъект);
							ИначеЕсли ЕстьСуммаНДС Тогда 
								ОбработкаТабличныхЧастей.РассчитатьСуммуНДСТабЧасти(СтрокаТабличнойЧасти, ДокументОбъект);
							КонецЕсли;
						КонецЕсли;
					КонецЕсли;
