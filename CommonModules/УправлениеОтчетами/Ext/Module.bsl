...
Функция СформироватьСтрокуОтборов(Отбор) Экспорт
	...
	Для а = 0 По Отбор.Количество() - 1 Цикл
		...
		Если ЭлементОтбора.ВидСравнения = ВидСравнения.Равно Тогда
			СтрокаОтборов = СтрокаОтборов + ЛокализацияПовтИсп.ПолучитьПереводТекста(ЭлементОтбора.Представление) + " = "+ ?(ЗначениеЗаполнено(ЭлементОтбора.Значение), СокрЛП(Строка(ЭлементОтбора.Значение)), НСтр("ru='Пусто';uk='Порожньо'", ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов()));
		...
		ИначеЕсли ЭлементОтбора.ВидСравнения = ВидСравнения.ВСписке Тогда
			...
			СтрокаОтборов = СтрокаОтборов 
							...
							+ НСтр("ru=' в списке ';uk=' в списку '", ЯзыкФормирования) 
							+ ?(ЗначениеЗаполнено(ЭлементОтбора.Значение), СтрокаСписка, НСтр("ru='Пусто';uk='Порожньо'", ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов()));
		ИначеЕсли ЭлементОтбора.ВидСравнения = ВидСравнения.ВСпискеПоИерархии Тогда
			...
			СтрокаОтборов = СтрокаОтборов 
							+ ЛокализацияПовтИсп.ПолучитьПереводТекста(ЭлементОтбора.Представление) 
							+ НСтр("ru=' в группе из списка ';uk=' в групі зі списку '", ЯзыкФормирования) 
							+ ?(ЗначениеЗаполнено(ЭлементОтбора.Значение), СтрокаСписка, НСтр("ru='Пусто';uk='Порожньо'", ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормОтчетов()));
