...
Функция СформироватьТекстЗапросаВременнаяТаблицаВыпускПродукцииРасширеннаяАналитика()
	...
	|	
	|	ЕСТЬNULL(ВариантыВыпускаПродукции.ВариантВыпускаПродукции, ЗНАЧЕНИЕ(Перечисление.ВариантыВыпускаПродукции.СобственнаяПродукция)) КАК ВариантВыпускаПродукции,
	|	
	|	
...
// Процедура устанавливает значения отбора построителя запроса.
//
// Параметры:
//	СтруктураПараметров - Структура - Структура параметров способа распределения
//	ПостроительЗапроса - ПостроительЗапроса
