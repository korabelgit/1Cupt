...
Процедура ВыполнитьРегистрациюИзмененийПоУзлуИМетаданному(УзелДляРегистрацииИзменений, МетаданныеДляОбмена, 
	...
	Если (НЕ РегистрироватьВсеИзменения)
		...
		ИмяРеквизитаОрганизации = "Организация";
		Если НЕ ЭтоРегистр Тогда
		...
		Иначе
			...
			Если НРег(ИмяСсылочногоТипа) = НРег("РегистрСведений.КонтактнаяИнформация") Тогда
				НаличиеОрганизации 		= Истина;
				ИмяРеквизитаОрганизации = "Объект";
			КонецЕсли;
		КонецЕсли;
		...
		Если НаличиеОрганизации
			...
			Если НаличиеОрганизации Тогда
				Если ИмяРеквизитаОрганизации = "Организация" Тогда
					ОграничениеВыборки = "ГДЕ РегистрацияИзменений.Организация В (&МассивОрганизаций)";
				Иначе
					ОграничениеВыборки = "ГДЕ (РегистрацияИзменений." + ИмяРеквизитаОрганизации + " В (&МассивОрганизаций)
						|	ИЛИ (НЕ(РегистрацияИзменений." + ИмяРеквизитаОрганизации + " ССЫЛКА Справочник.Организации)))"
				КонецЕсли;
			КонецЕсли;
