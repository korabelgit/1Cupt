...
Функция ПечатьПеремещениеТоваров(МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл
		...
		ВыводитьМеста = Истина;
			Если ВыгрузкаСтрокТовары.Итог("КоличествоМест") = 0 Тогда
				ВыводитьМеста = Ложь;
			КонецЕсли;
		...
		ОбластьДанных = Макет.ПолучитьОбласть("ШапкаТаблицы|Количество");
		...
		ОбластьДанных = Макет.ПолучитьОбласть("Строка|Количество");
		...
		ОбластьДанных = Макет.ПолучитьОбласть("Подвал|Количество");
