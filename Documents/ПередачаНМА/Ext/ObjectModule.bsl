...
Процедура ДвиженияПоРегистрамРегл(РежимПроведения, СтруктураШапкиДокумента, 
	...
	Если СтруктураШапкиДокумента.ОтражатьВБухгалтерскомУчете Тогда
		...
		ТаблицаДвиженийАмортизация = АмортизацияНМА.ВыгрузитьКолонки();
		...
		Для каждого СтрокаТЧ Из ТаблицаПоТоварам Цикл
			...
			Движение.СтоимостьНУ           = НалоговыйУчет.ОпределитьСтоимостьНУ(СтрокаТЧ.НалоговоеНазначение_НМА, СтрокаТЧ.СтоимостьНУ_НМА, СтруктураШапкиДокумента.ЕстьНалогНаПрибыль);
			...
			Если СуммаПроводки <> 0 Тогда
				...
				Если СтруктураШапкиДокумента.ЕстьНалогНаПрибыль Тогда	
					...
					Проводка.СуммаНУКт = НалоговыйУчет.ОпределитьСтоимостьНУ(СтрокаТЧ.НалоговоеНазначение_НМА, СтрокаТЧ.ОстСтоимостьНУ, СтруктураШапкиДокумента.ЕстьНалогНаПрибыль);
