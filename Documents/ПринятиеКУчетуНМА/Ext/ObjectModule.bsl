...
Процедура ФормированиеДвиженийРегл(СтруктураШапкиДокумента, Отказ, Заголовок)
	...
	Если СтруктураШапкиДокумента.ОтражатьВБухгалтерскомУчете Тогда
		...
		Проводка.Сумма        = СтруктураШапкиДокумента.СтоимостьБУ - ОбщаяСуммаКоррНалоговогоКредита;
			...
			Проводка.СуммаНУДт 	= НалоговыйУчет.ОпределитьСтоимостьНУ(СтруктураШапкиДокумента.НалоговоеНазначение,СтруктураШапкиДокумента.СтоимостьНУ - ОбщаяСуммаКоррНалоговогоКредита, СтруктураШапкиДокумента.ЕстьНалогНаПрибыль);
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Если ОтражатьВБухгалтерскомУчете Тогда 
		...
		Если НЕ УчетнаяПолитикаРегл.ЕстьНДС Тогда
			...
			Если ВидОперации = Перечисления.ВидыОперацийПринятияКУчетуНМА.ОбъектыСтроительства Тогда
				НалоговоеНазначениеОбъектаСтроительства = НеОблНДСДеятельность;
			КонецЕсли;	
