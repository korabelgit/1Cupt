...
Функция ПечатьПланаПроизводства()
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = ОбщегоНазначения.СформироватьЗаголовокДокумента(Шапка, НСтр("ru='План производства';uk='План виробництва';", КодЯзыкаПечать), КодЯзыкаПечать);
