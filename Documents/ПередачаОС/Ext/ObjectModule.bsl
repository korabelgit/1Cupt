	...
	Если СтруктураШапкиДокумента.ОтражатьВБухгалтерскомУчете Тогда
		...
		Для каждого СтрокаТЧ Из ТаблицаПоТоварам Цикл
			...
			Если НЕ (СтрокаТЧ.СтоимостьБУ = 0) Тогда
				...
				Движение.СтоимостьНУ           = НалоговыйУчет.ОпределитьСтоимостьНУ(СтрокаТЧ.НалоговоеНазначение_ОС, СтрокаТЧ.СтоимостьНУ_ОС, СтруктураШапкиДокумента.ЕстьНалогНаПрибыль);
				...
				Если СуммаПроводки <> 0 ИЛИ (СтрокаТЧ.ОстСтоимостьНУ <> 0 И СтруктураШапкиДокумента.ЕстьНалогНаПрибыль) Тогда
					...
					Если СтруктураШапкиДокумента.ЕстьНалогНаПрибыльДо2015 И СуммаНУРасход > 0 Тогда
						...
						Проводка.СуммаНУДт = НалоговыйУчет.ОпределитьСтоимостьНУ(СтрокаТЧ.НалоговоеНазначениеДоходовИЗатрат, СуммаНУРасход, СтруктураШапкиДокумента.ЕстьНалогНаПрибыльДо2015);
