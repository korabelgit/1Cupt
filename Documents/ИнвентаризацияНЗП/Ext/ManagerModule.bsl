...
Функция ПечатьИнвентаризация(МассивОбъектов, ОбъектыПечати, ТипУчета)
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл
		...
		ИнфоОрг = УправлениеКонтактнойИнформацией.СведенияОЮрФизЛице(Шапка.Организация, Ссылка.Дата,,,КодЯзыкаПечать);
		
		Область = Макет.ПолучитьОбласть("Шапка");
		Область.Параметры.ТекстЗаголовок   = ОбщегоНазначения.СформироватьЗаголовокДокумента(Шапка, НСтр("ru='Инвентаризация незавершенного производства';uk='Інвентаризація незавершеного виробництва';", КодЯзыкаПечать), КодЯзыкаПечать);
