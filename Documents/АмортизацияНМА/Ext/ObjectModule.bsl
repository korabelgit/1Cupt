...
Процедура ДвиженияПоРегистрам(СтруктураШапкиДокумента, Отказ, Заголовок)
	...
	Если СтруктураШапкиДокумента.ОтражатьВБухгалтерскомУчете ИЛИ ОтражатьВНалоговомУчете Тогда
		...
		ОтражатьВНУ = Истина;
		Если КонецМесяца(ПериодРегистрации) >= ДатаНКУ2015 Тогда 
			ОтражатьВНУ = ОтражатьВНалоговомУчете;
		КонецЕсли;	
		
		ТабАмортизации  = УправлениеВнеоборотнымиАктивами.РасчетАмортизацииНМАРегл(КонецМесяца(СтруктураШапкиДокумента.ПериодРегистрации), СтруктураШапкиДокумента.Организация, , СтруктураШапкиДокумента.ОтражатьВБухгалтерскомУчете, ОтражатьВНУ,, Отказ);
