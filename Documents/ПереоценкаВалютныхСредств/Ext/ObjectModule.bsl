...
Процедура ДвиженияПоРегистрамРегл(СтруктураШапкиДокумента, Отказ, Заголовок)
	...
	Если СтруктураПараметров.Период > глЗначениеПеременной("ДатаВступленияВСилуПриказа754") И СтруктураПараметров.Период < глЗначениеПеременной("ДатаВступленияВСилуПостановленияНБУ194") Тогда	
		СтруктураПараметров.Вставить("ДатаКурса", СтруктураПараметров.Период + 60 * 60 * 24);
	КонецЕсли; 
