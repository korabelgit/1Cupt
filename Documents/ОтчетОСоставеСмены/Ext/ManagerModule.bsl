...
Функция ПечатьОтчетаОСоставеСмены(МассивОбъектов, ОбъектыПечати)
	...
	Для каждого Ссылка Из МассивОбъектов Цикл
		...
		ОбластьМакета.Параметры.ТекстЗаголовка 		= ОбщегоНазначения.СформироватьЗаголовокДокумента(Шапка, НСтр("ru='Отчет о составе смены';uk='Звіт про склад зміни'", КодЯзыкаПечать), КодЯзыкаПечать);
