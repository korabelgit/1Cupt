...
Функция ПечатьУслугиСобственнымПодразделениям(МассивОбъектов, ОбъектыПечати)
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл
		...
		Область.Параметры.Заголовок 				= ОбщегоНазначения.СформироватьЗаголовокДокумента(Ссылка.ПолучитьОбъект(),,КодЯзыкаПечать);
...
Функция ПараметрыУчетаНоменклатуры(ДанныеДляЗаполнения) Экспорт
