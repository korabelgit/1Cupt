...
Процедура ДвиженияПоРегистрамПереработкаУпр(СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаПоМатериалам, ТаблицаПоУслугам)
	...
	ТаблицаДвиженийПост.ЗаполнитьЗначения( Перечисления.СтавкиНДС.БезНДС, "СтавкаНДС");
