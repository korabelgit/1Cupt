...
Функция ПечатьЛимитыОтпускаМатериалов()
	...
	Область.Параметры.ТекстЗаголовка = ОбщегоНазначения.СформироватьЗаголовокДокумента(Ссылка,, КодЯзыкаПечать);
	...
	Пока ВыборкаПоСтрокам.Следующий() Цикл
		...
		ОбластьМакета.Параметры.Периодичность = ЛокализацияПовтИсп.ПолучитьПереводТекста(ОбластьМакета.Параметры.Периодичность, КодЯзыкаПечать, ЛокализацияПовтИсп.КодЯзыкаИнтерфейса());
...
Процедура Печать(ИмяМакета, КоличествоЭкземпляров = 1, НаПринтер = Ложь) Экспорт
	...
	ОбщегоНазначения.СформироватьЗаголовокДокумента(Ссылка,,ЛокализацияПовтИсп.ПолучитьЯзыкФормированияПечатныхФормДокументов()), Ссылка);
