...
Функция ПечатьРезервированиеТоваров()
	...
	ОбластьМакета.Параметры.ТекстЗаголовка = ОбщегоНазначения.СформироватьЗаголовокДокумента(Шапка, НСтр("ru='Резервирование товаров';uk='Резервування товарів';", КодЯзыкаПечать), КодЯзыкаПечать);
