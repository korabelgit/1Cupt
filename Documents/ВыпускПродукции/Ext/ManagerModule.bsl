...
Функция ПечатьВыпускПродукции(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	Для Каждого Ссылка Из МассивОбъектов Цикл
		...
		ОбластьМакета.Параметры.ТекстЗаголовка = ОбщегоНазначения.СформироватьЗаголовокДокумента(Шапка, НСтр("ru='Выпуск продукции';uk='Випуск продукції'", КодЯзыкаПечать), КодЯзыкаПечать);
