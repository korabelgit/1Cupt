...
//
Процедура ПроверкаРеквизитов(Заголовок, Отказ, СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаПоТаре)
...
Процедура ДвиженияТоварыОрганизаций(СтруктураШапкиДокумента, ТаблицаПоТоварам, Заголовок, Отказ, РежимПроведения)
...
Процедура ДвиженияТоварыОрганизацийРегл(СтруктураШапкиДокумента, ТаблицаПоТоварам, Заголовок, Отказ, РежимПроведения)	
	...
	Если ВидОперации = Перечисления.ВидыОперацийВозвратТоваров.ИзПереработки Тогда
		...
		Для Каждого СтрокаТЧ Из ТаблицаПоТоварам Цикл	
			...
			НоваяСтрока = ТаблицаДвижений.Добавить();
			НоваяСтрока.Организация                = Организация;
            НоваяСтрока.Комиссионер                = Контрагент;
			НоваяСтрока.Номенклатура               = СтрокаТЧ.Номенклатура;
			НоваяСтрока.ХарактеристикаНоменклатуры = СтрокаТЧ.ХарактеристикаНоменклатуры;
			НоваяСтрока.СерияНоменклатуры          = СтрокаТЧ.СерияНоменклатуры;
			НоваяСтрока.Количество                 = СтрокаТЧ.Количество;
...
КонецПроцедуры // ДвиженияЗаказыПокупателей()   
...
КонецПроцедуры // ДвиженияТоварыПоОрдеруУпр()
...
Процедура ДвиженияТоварыПереданныеУпр(СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаПоТаре, Заголовок, Отказ, РежимПроведения)
	...
	Для Каждого СтрокаТЧ Из ТаблицаПоТаре Цикл
		...
		НоваяСтрока.Количество 				   = СтрокаТЧ.КоличествоДок;
		НоваяСтрока.СуммаВзаиморасчетов = МодульВалютногоУчета.ПересчитатьИзВалютыВВалюту(
												СтрокаТЧ.Сумма,
												ВалютаДокумента,
												СтруктураШапкиДокумента.ВалютаВзаиморасчетов,
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	ПроверкаРеквизитов(Заголовок, Отказ, СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаПоТаре);
	...
	ДвиженияТоварыОрганизаций(СтруктураШапкиДокумента, ТаблицаПоТоварам, Заголовок, Отказ, РежимПроведения);
	...
	ДвиженияПоРегиструСписанныеТовары(СтруктураШапкиДокумента, ТаблицаПоТоварам, ТаблицаПоТаре, Отказ, Заголовок, РежимПроведения);
	//>
