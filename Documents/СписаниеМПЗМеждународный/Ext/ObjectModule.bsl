...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	|	ПартииТоваровНаСкладах.КодОперации КАК КодОперацииВРегистреПартий,
	...
	|			ПартииТоваровНаСкладахБухгалтерскийУчет.КодОперации КАК КодОперации,
	...
	|			ПартииТоваровНаСкладахБухгалтерскийУчет.КодОперации,
	...
	Пока ВыборкаПоРегистратору.Следующий() И Не Отказ Цикл
		...
		Пока Выборка.Следующий() Цикл
			...
			Если Выборка.КодОперацииВРегистреПартий = Перечисления.КодыОперацийПартииТоваров.ВозвратОтПокупателяТекущийМесяц Тогда
			...
			Если Выборка.КодОперацииВРегистреПартий = Перечисления.КодыОперацийПартииТоваров.ВозвратОтПокупателяТекущийМесяц Тогда
				КопияДвижение.ДокументПартии = Ссылка;
				КопияДвижение.Количество = -КопияДвижение.Количество; 
			КонецЕсли; 
