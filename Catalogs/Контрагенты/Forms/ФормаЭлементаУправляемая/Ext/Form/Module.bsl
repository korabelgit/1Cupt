...
Процедура ПриОткрытии(Отказ)
	...
	ВидимостьФлагаДополненияНаименованияАдресаНН();
КонецПроцедуры
...
&НаКлиенте
Процедура ВидимостьФлагаДополненияНаименованияАдресаНН()
	
	Элементы.ДополнятьНаименованиеАдресДаннымиГоловногоКонтрагентаВНН.Доступность = ЗначениеЗаполнено(Объект.ГоловнойКонтрагент) И НЕ (Объект.ГоловнойКонтрагент = Объект.Ссылка);
