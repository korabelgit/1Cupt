...
Функция Печать() Экспорт
	...
	Если ЗанятияКурса.Количество() > 0 Тогда
		...
		|	ЕСТЬNULL(КурсыОбученияЗанятияКурса.Занятие.ВидЗанятия.Наименование, """+НСтр("ru='форма обучения не указана';uk='форма навчання не зазначена'",КодЯзыкаПечать)+""") КАК ФормаОбучения
		|ИЗ
